  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-2">
        <p className="pb-1.5 mb-2.5 border-b border-gray-700"><strong>Congrats!</strong> You are eligible for <strong>FREE Shipping</strong></p>
        ...
        <div className="overflow-y-scroll scrollbar-hide h-[420px]">
            <div className="mt-3 flex justify-between pb-3 border-b border-b-gray-800">
                <div className="bg-[#F5F5F5] flex items-center p-2 rounded-sm">
                    <img className="size-10" src="./ambition.png" alt="" />
                </div>
                <div>
                    <h3 className="text-lg font-semibold">Zebronics Bluetooth...</h3>
                    <p>$210.00</p>
                    ...
                    <div className="mt-2 w-[110px] flex items-center border border-zinc-600">
                        ...
                        <button className="border-l-2 px-3 py-2 font-medium">+</button>
                    </div>
                </div>
      ...
      <div className="absolute w-full h-28 bottom-0">
        ...
        <div className="mt-5 bottom-0 w-full flex">
            <a className="bg-gray-600 text-white w-1/2 py-2 text-center" href="#">View Cart</a>
            <a className="bg-gray-900 text-white w-1/2 py-2 text-center" href="#">Checkout</a>
        </div>
      </div>
      </div>
    </div>
